...
export default function App() {
  ...
  return <div className="page">
    ...
    <dialog ref={paywall} className="report-dialog" aria-labelledby={subscription ? "subscription-title" : "paywall-title"} onClose={() => { setCheckoutNotice(false); setSubscription(false); }}>
